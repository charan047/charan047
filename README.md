...
- **Full-time roles:** SDE / SWE / Full-Stack / Backend / AI-ML  
- **Strengths:** API design • DB optimization • UI polish • deployment automation  
- **Interest areas:** system design • distributed systems • applied ML/CV
...
**Cloud/DB:** AWS • MySQL • PostgreSQL • MongoDB  
**ML/CV:** PyTorch • TensorFlow • OpenCV • scikit-learn • Pandas • NumPy

---

## ⭐ Featured Projects

### **Aethon.AI — Open-Source Operating System for AI Agencies**
A full multi-tenant platform for agencies that deploy AI agents on behalf of clients — combining client workspaces, agent management, workflow orchestration, live execution monitoring, approval flows, and white-label client portals in one self-hosted stack.

- **Repo:** https://github.com/charan047/AETHON.AI  
- **Highlights:** Unlimited clients/agents/workflows, trust scores & permission engine, approval flows for high-risk tool usage, live execution streaming, 9 prebuilt marketplace templates, self-hostable via Docker Compose
...
- Integrated cloud services (storage, deployments, monitoring) using **AWS**
